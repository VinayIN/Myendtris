...
# the following is visual basic (or god knows what) that needs to be translated into python, e.g., using win32com
#hr = SpGetDefaultTokenFromCategoryId(SPCAT_AUDIOIN, &cpObjectToken;);
#hr = _recognizer.SetInput(cpObjectToken, True)
...
def _startlistening(phraselist, callback):
    ...
    #grammar.SetGrammarState(_constants.SGSExclusive)
