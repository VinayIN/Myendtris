...
@org        Team PhyPA, Brandenburgische Technische Universität Cottbus-Senftenberg
@date       2023-05-16
"""
...
class DiscoLightsDemo(ShowBase):
    ...
    def __init__(self):
        ...
        self.disco = loader.loadModel("../../../media/models/disco_hall")
        ...
        self.redHelper = loader.loadModel('../../../media/models/sphere')
        ...
        self.greenHelper = loader.loadModel('../../../media/models/sphere')
        ...
        self.blueHelper = loader.loadModel('../../../media/models/sphere')
